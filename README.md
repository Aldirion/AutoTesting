...
<table class="table">
	...
	<tr>
		...
		<td>
			...
			<ol>
				<li>Ввести ИНН искомой организации в поле поиска</li>
	...
	<tr>
		...
		<td>
			...
			<ol>
				<li>Ввести ОГРН искомой организации в поле поиска</li>
				<li>Нажать на кнопку "найти"</li>
				<li>Записать в LOG адрес страницы с карточкой организации</li>
			</ol>
		</td>
	...
	<tr>
		...
		<td>
			...
			<ol>
				<li>Нажать на название организации</li>
				<li>Записать в лог адрес страницы с карточкой организации</li>
			</ol>
		</td>
		<td><ol>
			<li>Открывается страница с подробной информацией об организации(сводка)</li>
	...
	<tr>
		...
		<td>
			...
			<ol>
				...
				<li>Записать в LOG адрес страницы с выпиской из ЕГРЮЛ</li>
			</ol>
		</td>
		<td><ol>
